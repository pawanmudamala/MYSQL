...
select EMP_ID,FIRST_NAME,LAST_NAME,JOB_ID from myemp limit 5;

select EMP_ID,LAST_NAME,JOB_ID, salary from myemp order by salary;

select EMP_ID,LAST_NAME,JOB_ID, salary from myemp order by salary desc;

select EMP_ID,LAST_NAME,JOB_ID, salary from myemp order by salary desc limit 10;

select dep_id from myemp;

select distinct dep_ID from myemp;

select EMP_ID,LAST_NAME,JOB_ID, salary from myemp order by salary limit 10;
...
select * from myemp order by dep_id asc;
...
select * from myemp where dep_id between 10 and 50;

select emp_id, first_name, salary, mgr_id from myemp where mgr_id in (100,101,102);

select emp_id, first_name, salary, mgr_id, dep_id from myemp where dep_id=90 and mgr_id=100;

select emp_id, first_name, salary, mgr_id from myemp where dep_id=90 or mgr_id=100; 
